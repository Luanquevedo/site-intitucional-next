...
const AboutContainer = () => {
  return (
    <section>
      <Head>
        <title>Diferenciais - Viva Eventos</title>
        <meta
          name="description"
          content="Conheça os diferenciais do Viva Eventos, oferecendo personalização, ingredientes selecionados e atendimento exclusivo em cada evento."
        />
        <meta
          name="keywords"
